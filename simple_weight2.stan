...
model {
  // Log-likelihood
  log_weight ~ normal(beta[1] + beta[2] * log_gest + beta[3]*preterm + beta[4]*log_gest_preterm, sigma);
...
generated quantities {
  ...
  for (n in 1:N) {
    real log_weight_hat_n = beta[1] + beta[2] * log_gest[n] + beta[3]*preterm[n] + beta[4]*log_gest_preterm[n];
