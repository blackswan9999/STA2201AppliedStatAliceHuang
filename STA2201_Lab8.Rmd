...
The VR source is the only one that has the most recent observation in 2014. If we exclude VR, the next most recent observation is from 2005. Since the first order random walk projection depends on the most recent observation, excluding VR will make the projections be based off older observations, and potentially be less accurate. 
...
I think the second order random walk model is more appropriate for data excluding the VR source. Since the first order random walk projection depends on the most recent observation, excluding VR will make the projections be based off older observations, and potentially be less accurate. 