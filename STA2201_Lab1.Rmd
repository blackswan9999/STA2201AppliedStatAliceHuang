...
```{r}
dm %>% group_by(Year) %>%
  summarize(max_fem_mortality = max(Female))
```
...
From 1975-2020, it looks like the gap between the Female and Male average population-weighted mortality is increasing.