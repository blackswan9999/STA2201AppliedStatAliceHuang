...
```{r}
kidiq %>% ggplot(aes(x=factor(mom_age), y=kid_score)) + geom_boxplot()
```

There does not appear to be a significant difference between the medians of the kids' IQ scores as the mother's age increases.
...
fit2 <- stan(file = here("C:/Users/Alice/Desktop/GRAD SCHOOL/STA2201/STA2201AppliedStatAliceHuang/kids2.stan"),
            data = data,
            chains = 3,
            iter = 500)
```
