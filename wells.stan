...
data {
  ...
  vector[N] cent_dist;
  vector[N] cent_arsenic;
  vector[N] cent_dist_cent_arsenic;
}
...
model {
  ...
  switch_well ~ bernoulli_logit(beta[1] + beta[2]*cent_dist + beta[3]*cent_arsenic + beta[4]*cent_dist_cent_arsenic);
...
generated quantities {
  ...
  for (n in 1:N) {
    real log_switch_hat_n = beta[1] + beta[2]*cent_dist[n] + beta[3]*cent_arsenic[n] + beta[4]*cent_dist_cent_arsenic[n];
